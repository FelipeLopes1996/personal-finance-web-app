...
export const infoCardHomeData: InfoCardProps[] = [
  {
    icon: (
      <svg
    ...
    title: "Controle Total de Transações",
    infoText:
      "Registre suas receitas e despesas com facilidade, categorize tudo e nunca mais perca o rastro do seu dinheiro.",
    isInComing: false,
  },
  {
    icon: (
